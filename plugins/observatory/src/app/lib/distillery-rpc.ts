...
// the shared module hook keeps them apart: a module that is not running must
// not render as an empty queue, because "nothing to review" is exactly the
// answer a reader would act on.
import { useCallback, useEffect, useRef, useState } from "react";
import { useRpc } from "@get-bb/plugin-sdk/app";
import { isFixtureMode } from "@/lib/module-rpc";
import type {
  ClusterView,
  CorrectionView,
  DistillAction,
